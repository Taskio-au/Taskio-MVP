...
| P05 | **STAGING PASS / PRODUCTION PENDING** — plan **COMPLETE**. **P05G1A** token-race fix and **P05G1B** browser/API plan required before RED enforcement | Yes, until production PASS |
