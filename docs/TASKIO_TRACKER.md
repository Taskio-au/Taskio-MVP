...
| P07 | Production security and configuration | **OPEN / REMEDIATION IN PROGRESS.** P07A/P07B/P07C complete; P07D1 prepared; P07D2A proven; P07D2B **AMBER-D1B COMPLETE**; AMBER-E2A+E2B+E2C+D3 **COMPLETE**; **P07F1 AUDIT COMPLETE**; **P07F2 REMEDIATION COMPLETE**; **P07F3 STAGING DEPLOYMENT COMPLETE**; **P07F4 PRODUCTION READ-ONLY AUDIT COMPLETE**; **P07F5A OWNER REVIEW DOSSIER COMPLETE**; **P07F5B OWNER DECISION COMPLETE — OPTION B** (`docs/P07_SECURITY_CONFIG_REMEDIATION.md` §42). Legacy Expert compatibility blocker **RESOLVED**. **FIXED PRODUCTION API: COMPATIBILITY REVIEW COMPLETE** — **not** a deploy approval. Staging CSP **ENFORCED**. **Not PASS.** Remaining: production Auth/App Check/email/analytics/Stripe/Storage rules/Hosting, Functions remaining highs, later Expert reconfirmation before launch. Current cloud `disabledUserSignup=true` blocks brand-new Firebase users; P07 cannot PASS public OPEN while that remains. See `docs/LAUNCH_READINESS.md`. |
