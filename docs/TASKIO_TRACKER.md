...
| P07 | Production security and configuration | **OPEN / REMEDIATION IN PROGRESS.** P07A/P07B/P07C complete; P07D1 prepared; P07D2A proven; P07D2B **AMBER-D1B COMPLETE** (`docs/P07_SECURITY_CONFIG_REMEDIATION.md` §30): staging key last-4 `f04d` deleted; local JSON deleted; ADC remains. Historical cloud use **UNKNOWN**. **Not PASS.** Remaining: staging CSP, production Auth/App Check/email/analytics/Stripe/Storage rules/Hosting, Functions remaining highs, legacy Expert review. Current cloud `disabledUserSignup=true` blocks brand-new Firebase users; P07 cannot PASS public OPEN while that remains. See `docs/LAUNCH_READINESS.md`. |
