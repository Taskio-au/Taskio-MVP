...
| P06 | Legal review | **OPEN.** Inventory **COMPLETE**. Owner facts **COMPLETE**. **LEGAL STRUCTURE REVIEW:** required before controlled real-user pilot. Current sole-trader pilot: permitted by owner as working plan, **subject to AU solicitor confirmation**. **COMPANY CONVERSION:** deferred unless required/advised before pilot; must be reconsidered before broader scaling. **INSURANCE:** minimum pilot position must be reviewed with broker/solicitor before real users; broad insurance expansion can scale with traction/risk. Accounting marketplace/GST **PENDING**. Remediation **NOT STARTED**. **Not PASS.** Pty Ltd is **not** a tracker launch blocker unless professionally advised. See `docs/P06_OWNER_DECISIONS.md`. Do not start P09 UI until P06 PASS. |
...
**Exact next pickup:** **P06** focused AU solicitor review (Stage 1 controlled pilot + Stage 2 scale) of `docs/P06_OWNER_DECISIONS.md` and `docs/P06_SOLICITOR_BRIEF.md`, plus focused insurance-broker discussion (minimum sensible pilot cover) and accountant marketplace/GST confirmation. Owner facts **COMPLETE**. Do **not** treat Pty Ltd or broad insurance as automatic blockers. Do **not** mark P06 PASS, start P09 UI/copy, enable Auth App Check, roll back Hosting while Firestore or Storage is ENFORCED, start P02B, start P11, change DNS, or configure production email/App Check/analytics tonight. Production remains frozen.
...
| P06 | Final Terms/Privacy owner + preferably AU legal review | **OPEN.** Owner facts **COMPLETE**. Lean sole-trader controlled pilot as owner working plan, subject to solicitor confirmation. Pty Ltd **not** an automatic launch blocker. Insurance = focused minimum-pilot review. Remediation **NOT STARTED**. **Not PASS.** |
