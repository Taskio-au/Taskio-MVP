...
| P07 | Production security and configuration | **OPEN / REMEDIATION IN PROGRESS.** P07A/P07B/P07C complete; P07D1 prepared; P07D2A proven; P07D2B **AMBER-D1B COMPLETE**; AMBER-E2A+E2B+E2C+D3 **COMPLETE**; **P07F1 AUDIT COMPLETE**; **P07F2 LOCAL REMEDIATION COMPLETE / DEPLOYMENT PENDING** (`docs/P07_SECURITY_CONFIG_REMEDIATION.md` §38): expertise fail-closed locally, not deployed. Staging data remediation **not required**. Staging CSP **ENFORCED**. **Not PASS.** Remaining: deploy P07F2 when approved; production Auth/App Check/email/analytics/Stripe/Storage rules/Hosting, Functions remaining highs, **production** legacy Expert review. Current cloud `disabledUserSignup=true` blocks brand-new Firebase users; P07 cannot PASS public OPEN while that remains. See `docs/LAUNCH_READINESS.md`. |
