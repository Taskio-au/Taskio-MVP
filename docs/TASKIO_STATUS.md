...
**Last updated:** 20 September 2026 (P07E2B AMBER-E2B complete — staging API current HEAD; Hosting pending)
...
| P07 | **OPEN / REMEDIATION IN PROGRESS** — **AMBER-E2A+E2B COMPLETE**. Rules HEAD; API `00070-dur` 100%. Hosting still `e97a303dcf995e37` / `main.70b28def.js`. E2C pending. CSP Report-Only live; enforcement not approved. Not PASS. | **Yes** |
| P08 | **NOT STARTED** | **Yes** |
...
- Remaining prelaunch gates: **P01** bank payout **PASS / COMPLETE**; **P02** normal refund **PROVEN / COMPLETE** (P02B optional/not proven); **P03** **STAGING PASS / PRODUCTION PENDING** (authentic E01 delivered); **P04** **STAGING PASS / PRODUCTION PENDING** (owner-confirmed Realtime); **P05** **STAGING PASS / PRODUCTION PENDING** (Firestore + Storage enforced; Auth out of MVP scope); **P06** **OPEN** (owner facts complete; P06A reconciliation prepared; lean sole-trader pilot subject to solicitor confirmation; Pty Ltd not an automatic blocker; focused insurance review pending; not PASS); **P07** **OPEN / REMEDIATION IN PROGRESS** (AMBER-E2A+E2B complete; Hosting pending; CSP Report-Only live; enforcement and production Auth/App Check/email/analytics/Stripe/Hosting/rules remain; not PASS); **P08 / P10** **NOT STARTED**; **P09** blocked on P06; **P11** **BLOCKED**.
...
P01 and P02 staging TEST money-path proofs are **COMPLETE**. P03, P04, and P05 staging are **PASS / PRODUCTION PENDING**. P07 is **OPEN / REMEDIATION IN PROGRESS** (AMBER-E2A+E2B **COMPLETE**; E2C Hosting pending; CSP not enforced; not PASS). P06 **OPEN**. P09 **BLOCKED BY P06**. P08/P10 are not started. Do not infer production launch. Do not start P11. Next pickups remain **P06** solicitor pack, **AMBER-E2C** if approved, and remaining **P07** RED packages.
