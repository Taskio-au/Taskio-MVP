...
**Last updated:** 25 September 2026 (P05G1 App Check plan)
...
| P05 | **STAGING PASS / PRODUCTION PENDING** — plan **COMPLETE**. Blocked on **P05G1A** first-token readiness and **P05G1B** browser/API proof surface before any RED enforcement. Firestore + Storage only | Yes, until production PASS |
