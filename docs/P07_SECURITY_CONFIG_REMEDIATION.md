...
| P07-06 | Production App Check | **P07C:** Firestore/Storage/Auth `UNENFORCED`. P05G1 plan **COMPLETE**. Blocked on P05G1A token race and P05G1B browser/API plan. Auth enforcement out of MVP scope | C5 | HIGH bots/abuse at public launch | P05G1A then P05G1B, then RED | PRODUCTION | **RED / NOT APPROVED** | **Yes** (with P05) | Token + Firestore/Storage enforcement proofs | **PLAN COMPLETE; ENFORCEMENT NOT STARTED** |
