...
| P07-06 | Production App Check | **P07C:** Firestore/Storage/Auth `UNENFORCED`. P05G1 plan **COMPLETE**. Auth enforcement out of MVP scope | C5 | HIGH bots/abuse at public launch | P05G2–G4 | PRODUCTION | **RED / NOT APPROVED** | **Yes** (with P05) | Token + Firestore/Storage enforcement proofs | **PLAN COMPLETE; ENFORCEMENT NOT STARTED** |
