...
async function buildJobAttentionSnapshot(db, options = {}) {
  ...
  return {
    ...
    thresholds: {
      ...
      quoteClock: 'createdAt',
      fundedStall: 'deferred — no reliable agreed/scheduled work timestamp',
      completionStallHours: 48,
      note: 'Pilot operational triggers, not customer SLAs. Quote-liquidity uses createdAt. FUNDED_JOB_STALLED is not emitted. 6h / 24h quoting rules are superseded.',
    },
    totals: {
